...
export const mockExperiments: ExperimentSummary[] = [
  {
    ...
    experiment_name: 'Q1 2024 Momentum Sweep',
    ...
    end_date: '2024-03-31',
    dataset_version: 'raw_bars_v43',
    total_strategies: 512,
    strategies_passed_filters: 47,
    best_sharpe: 2.11,
    best_return: 0.282,
    progress: null,
  },
  {
    ...
    experiment_name: 'AAPL vs MSFT A/B',
    experiment_type: 'ab_comparison',
    status: 'running',
    ...
    total_strategies: 0,
    strategies_passed_filters: 0,
    best_sharpe: null,
    best_return: null,
    progress: 34,
  },
  {
    experiment_id: 'EXP-20260509-003',
    experiment_name: 'Full Year Backtest 2023',
    ...
    end_date: '2023-12-31',
    dataset_version: 'raw_bars_v41',
    total_strategies: 1024,
    strategies_passed_filters: 89,
    best_sharpe: 1.94,
    best_return: 0.241,
    progress: null,
  },
  {
    experiment_id: 'EXP-20260508-004',
    experiment_name: 'Rolling 30d Windows — Tech',
    experiment_type: 'rolling_window',
    status: 'failed',
  ...
  },
  {
    ...
    experiment_name: 'Mean Reversion Q2 Sweep',
    experiment_type: 'parameter_sweep',
    status: 'pending',
...
export const mockExperimentStrategies: Record<string, ExperimentStrategy[]> = {
  'EXP-20260510-001': [
    {
      strategy_id: 'STR-EXP001-001',
      sharpe_ratio: 2.11,
      total_return: 0.282,
      max_drawdown: -0.124,
      simulation_stage: 4,
      governance_state: 'approved_for_paper_trading',
      composite_score: 0.921,
      status: 'completed',
    },
    {
      strategy_id: 'STR-EXP001-002',
      sharpe_ratio: 1.87,
      total_return: 0.221,
      max_drawdown: -0.098,
      simulation_stage: 4,
      governance_state: 'research',
      composite_score: 0.811,
      status: 'completed',
    },
    {
      strategy_id: 'STR-EXP001-003',
      sharpe_ratio: 1.54,
      total_return: 0.187,
      max_drawdown: -0.143,
      simulation_stage: 3,
    ...
    {
      strategy_id: 'STR-EXP001-005',
      sharpe_ratio: 0.89,
      total_return: 0.091,
      max_drawdown: -0.187,
      simulation_stage: 2,
      governance_state: 'research',
      composite_score: 0.341,
      status: 'completed',
    },
  ],
  'EXP-20260509-003': [
    {
      strategy_id: 'STR-EXP003-001',
      sharpe_ratio: 1.94,
      total_return: 0.241,
      max_drawdown: -0.108,
      simulation_stage: 4,
      governance_state: 'approved_for_live_trading',
      composite_score: 0.878,
      status: 'completed',
    },
    {
      strategy_id: 'STR-EXP003-002',
      sharpe_ratio: 1.71,
      total_return: 0.198,
      max_drawdown: -0.132,
      simulation_stage: 4,
